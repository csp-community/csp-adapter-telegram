...
To work on `csp-adapter-telegram`, you are going to need to build it from source. See
[Build from Source](Build-from-Source) for
detailed build instructions.

Once you've built `csp-adapter-telegram` from a `git` clone, you will also need to
configure `git` and your GitHub account for `csp-adapter-telegram` development.

## Step 2: Configuring Git and GitHub for Development

### Create your fork

The first step is to create a personal fork of `csp-adapter-telegram`. To do so, click
the "fork" button at https://github.com/csp-community/csp-adapter-telegram, or just navigate
[here](https://github.com/csp-community/csp-adapter-telegram/fork) in your browser. Set the
