...
lint-py:  ## lint python with ruff
	python -m ruff check csp_adapter_telegram
	python -m ruff format --check csp_adapter_telegram
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix csp_adapter_telegram
	python -m ruff format csp_adapter_telegram
...
test:  ## run python tests
	python -m pytest -v csp_adapter_telegram/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v csp_adapter_telegram/tests --cov=csp_adapter_telegram --cov-report term-missing --cov-report xml
